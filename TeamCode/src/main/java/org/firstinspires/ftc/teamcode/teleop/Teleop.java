...
public class Teleop {
    ...
    public void loop() {
        ...
        specimenOffWall = !hasSpecimen && !hasSample && !powerTakeOff.isEnabled() && (gamepad1.dpad_up || gamepad2.dpad_up); //1 2
...
//        lowSpecimen;
        ...
        grabClaw = !hasSpecimen && !hasSample && (gamepad1.left_bumper || gamepad2.right_bumper); //1
