...
public class DeprecatedTeleop {
    ...
    public DeprecatedTeleop(HardwareMap hardwareMap, Telemetry telemetry, Gamepad gamepad1, Gamepad gamepad2, RobotSideEnum robotSide) {
...
//            driveTrain.PTOLoop(Math.min(0.25, Math.max( ( (PTOError - 60) / 500), 0 )));
        ...
        if (unjammingIntake) {
            ...
            if (elapsedTime.milliseconds() > unjamTime + Constants.Intake.unjamTimeMillisTeleop) {
