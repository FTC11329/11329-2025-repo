...
//        telemetry = dashboard.getTelemetry();
    ...
    public void loop() {
        ...
        lowBasket = gamepad2.dpad_down && (robotState.atStorePos || robotState.whereAmI == PlacePosEnum.highBasket);
        ...
        if (transfer) {
            ...
            intakeingColor = false;
            intakeing = false;
            stateMachine.goTransfer(robotState.atStorePos);
        }
