...
public class CommonPoses {
    ...
    public static Pose intakeSubLeftMiddle  = new Pose(-24, 48);
    ...
    public static Pose leftOuterSpike3 = new Pose(-49, 106, Math.toRadians(117));
    public static Pose leftOuterSpike2 = new Pose(-51.2, 105.9, Math.toRadians(90));
    public static Pose leftOuterSpike1 = new Pose(-51, 100, Math.toRadians(81));

    public static Pose rightOuterSpike1 = new Pose(-49, -106, Math.toRadians(81));
    public static Pose rightOuterSpike2 = new Pose(-51.2, -105.9, Math.toRadians(90));
    public static Pose rightOuterSpike3 = new Pose(-51, -100, Math.toRadians(117));
